...
sub_commands=(install install_configs install_zsh_config install_bash_config install_homebrew_apps install_homebrew_cli install_dev_apps check_repo_config setup_app_defaults echo)
